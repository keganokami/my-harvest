...
/* ---------------- タマネギ ---------------- */
{
  ...
  perM2: 40,
  stdQty: 40,   // 2人家族の目安株数
  sowing: { type: 'nursery', thin: '苗床にすじまきし、間引かずに育てる。鉛筆の太さ（7〜8mm）の苗を選んで定植する', edible: false },
...
/* ---------------- 九条ネギ ---------------- */
{
  ...
  perM2: 100,
  stdQty: 20,   // 2人家族の目安株数
  sowing: { type: 'nursery', thin: '苗床で育てて定植する。畝では間引かない', edible: false },
...
/* ---------------- ニラ ---------------- */
{
  ...
  perM2: 20,
  stdQty: 4,   // 2人家族の目安株数
  sowing: { type: 'nursery', thin: 'ポット・苗床で育てて定植する。畝では間引かない', edible: false },
...
/* ---------------- シソ（大葉） ---------------- */
{
  ...
  perM2: 8,
  stdQty: 1,   // 2人家族の目安株数
  sowing: { type: 'line', perCm: 0.5, thin: '本葉2〜3枚で最終30cm間隔に', edible: true },
...
/* ---------------- バジル ---------------- */
{
  ...
  perM2: 12,
  stdQty: 2,   // 2人家族の目安株数
  sowing: { type: 'line', perCm: 0.5, thin: '本葉2〜3枚で最終25cm間隔に', edible: true },
...
/* ---------------- パセリ ---------------- */
{
  ...
  perM2: 16,
  stdQty: 2,   // 2人家族の目安株数
  sowing: { type: 'nursery', thin: '発芽に3週間かかる。ポットで育ててから定植するか、苗を買うのが確実', edible: false },
