...
/* ---------------- ミニトマト ---------------- */
{
  ...
  perM2: 3,
  stdQty: 2,   // 2人家族の目安株数
  sowing: { type: 'nursery', thin: 'ポットに数粒まき、本葉が出たら1本に間引く。畝に定植したあとは間引かない', edible: false },
...
/* ---------------- キュウリ ---------------- */
{
  ...
  perM2: 3,
  stdQty: 2,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 3, thin: '本葉1枚で1本立ちに', edible: false },
...
/* ---------------- エダマメ ---------------- */
{
  ...
  perM2: 12,
  stdQty: 15,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 3, thin: '本葉が開いたら2本立ちに（1本より2本のほうが実付きが良い）', edible: false },
...
/* ---------------- オクラ ---------------- */
{
  ...
  perM2: 6,
  stdQty: 3,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 4, thin: '本葉2枚で2本立ちに（生育がゆるやかになり実が硬くなりにくい）', edible: false },
...
/* ---------------- ゴーヤ ---------------- */
{
  ...
  perM2: 2,
  stdQty: 1,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 2, thin: '本葉2枚で1本立ちに', edible: false },
...
/* ---------------- インゲン ---------------- */
{
  ...
  perM2: 12,
  stdQty: 8,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 3, thin: '発芽後2本立ちに', edible: false },
...
/* ---------------- スナップエンドウ ---------------- */
{
  ...
  perM2: 6,
  stdQty: 6,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 4, thin: '越冬前に2〜3本立ちに', edible: false },
...
/* ---------------- ソラマメ ---------------- */
{
  ...
  perM2: 4,
  stdQty: 6,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 1, thin: '間引きなし。春に枝を6〜7本に整枝する', edible: false },
...
/* ---------------- ズッキーニ ---------------- */
{
  ...
  perM2: 1,
  stdQty: 1,   // 2人家族の目安株数
  sowing: { type: 'point', perSpot: 3, thin: '本葉2枚で1本立ちに', edible: false },
