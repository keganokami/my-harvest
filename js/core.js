...
const SITE = {
  ...
  corrections: [
    ...
    '梅雨（6月中旬〜7月中旬）は多湿。ベランダより地面のほうが病気が出やすいので株間を広めに。',
    '真夏（7月下旬〜8月）は日中35℃超え。ベランダのコンクリート照り返しで鉢は50℃近くになります。'
  ]
};
...
const FAMILY_INFO = {
  ...
  'シソ科': {
    ...
    tip: 'ミントは地植え厳禁（地下茎で庭を制圧します）。必ず鉢で。'
  },
  'アオイ科': {
    rest: 2,
    color: '#c98a5e',
...
/* ---------------------------------------------------------
   ...
   --------------------------------------------------------- */
const AREA = {
  // 3畳 ≒ 4.86m²（1畳=1.62m²）。通路を除いた実作付け面積は約 3.5m²
  tatami: 3,
  totalM2: 4.86,
  usableM2: 3.5,
  note: '3畳＝約4.86m²。通路を差し引いた実際の作付け可能面積は約3.5m²（例: 幅70cm×長さ250cm の畝が2本）。'
};
